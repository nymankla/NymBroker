...
public static class MessageBrokerBuilderRabbitMqExtensions
{
    ...
    public static MessageBrokerBuilder AddRabbitMqEndPoint(
        this MessageBrokerBuilder builder, string name, RabbitMqSettings? settings = null)
    {
    ...
    /// </code>
    /// </summary>
    public static MessageBrokerBuilder WithRabbitMq(this MessageBrokerBuilder builder)
    {
