...
internal sealed class TopicBuilder<T> : ITopicBuilder<T> where T : class
{
    ...
    private readonly MessageBrokerBuilder _parent;
    ...
    public TopicBuilder(string topicName, Action<TopicContext> register, MessageBrokerBuilder parent)
    {
    ...
    public MessageBrokerBuilder Build()
    {
