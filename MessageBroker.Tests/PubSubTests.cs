...
public sealed class PubSubTests
{
    ...
    /// <summary>
    /// Builds a bare MessageBrokerImpl with no endpoints, consumers, or topics pre-registered.
    /// Caller is responsible for adding endpoints and topics.
    /// </summary>
    private static (MessageBrokerImpl Broker, IServiceProvider ServiceProvider) BuildBroker(
    ...
    // =========================================================================
    // 13. AddTopic<T> via MessageBrokerBuilder fluent API
    // =========================================================================
